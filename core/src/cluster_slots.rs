use {
    ...
    paychains_runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    paychains_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, paychains_runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_peer_2() {
        ...
        let k1 = paychains_sdk::pubkey::new_rand();
        let k2 = paychains_sdk::pubkey::new_rand();
    ...
    fn test_best_completed_slot_peer() {
        ...
        for ci in contact_infos.iter_mut() {
            ci.id = paychains_sdk::pubkey::new_rand();
        }
        let slot = 9;
