...
use {
    ...
    log::*,
    paychains_core::retransmit_stage::retransmitter,
...
// the case since https://github.com/paychains-labs/paychains/pull/17716.
...
fn bench_retransmitter(bencher: &mut Bencher) {
    ...
    let retransmitter_handles = retransmitter(
        ...
        cluster_info,
        shreds_receiver,
        Arc::default(), // paychains_rpc::max_slots::MaxSlots
        None,
    );
