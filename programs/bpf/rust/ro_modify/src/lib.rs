...
extern "C" {
    fn pay_invoke_signed_c(
        instruction_addr: *const PayInstruction,
        account_infos_addr: *const PayAccountInfo,
        account_infos_len: u64,
        signers_seeds_addr: *const PaySignerSeedsC,
        signers_seeds_len: u64,
    ) -> u64;
}

const READONLY_ACCOUNTS: &[PayAccountInfo] = &[
    PayAccountInfo {
        is_signer: false,
        is_writable: false,
        executable: true,
...
fn process_instruction(
    ...
    match instruction_data[0] {
        1 => {
            ...
            let metas = &[PayAccountMeta {
                is_signer: true,
                is_writable: true,
                pubkey_addr: accounts[1].key as *const _ as u64,
            }];
            let instruction = PayInstruction {
