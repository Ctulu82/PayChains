...
use {
    ...
    paychains_sdk::{packet::PACKET_DATA_SIZE, pubkey::Pubkey, timing::timestamp},
...
mod test {
    ...
    fn test_prune() {
        ...
        let self_id = paychains_sdk::pubkey::new_rand();
        let origin = paychains_sdk::pubkey::new_rand();
        ...
        let low_staked_peers = (0..10).map(|_| paychains_sdk::pubkey::new_rand());
        ...
        let high_staked_peer = paychains_sdk::pubkey::new_rand();
    ...
    fn test_process_push_old_version() {
        let crds = RwLock::<Crds>::default();
        let push = CrdsGossipPush::default();
        let mut ci = ContactInfo::new_localhost(&paychains_sdk::pubkey::new_rand(), 0);
        ci.wallclock = 1;
