...
#[allow(deprecated)]
use paychains_sdk::recent_blockhashes_account;
use {
    crate::{
...
impl Bank {
            ...
            stakes
                ...
                .for_each(|(stake_pubkey, delegation)| {
                    ...
                    let stake_delegation = match self.get_account_with_fixed_root(stake_pubkey) {
                        Some(stake_account) => {
                            if stake_account.owner() != &paychains_stake_program::id() {
                                invalid_stake_keys
    ...
    pub fn add_precompiled_account(&self, program_id: &Pubkey) {
        ...
        let account = AccountSharedData::from(Account {
            lamports,
            owner: paychains_sdk::system_program::id(),
            data: vec![],
            executable: true,
            rent_epoch,
        });
    ...
    fn use_multi_epoch_collection_cycle(&self, epoch: Epoch) -> bool {
        ...
        #[cfg(not(test))]
        if self.slot_count_per_normal_epoch() == paychains_sdk::epoch_schedule::MINIMUM_SLOTS_PER_EPOCH
        {
            return false;
        }
    ...
    fn reconfigure_token2_native_mint(&mut self) {
        ...
        if reconfigure_token2_native_mint {
            let mut native_mint_account = paychains_sdk::account::AccountSharedData::from(Account {
                owner: inline_spl_token::id(),
                data: inline_spl_token::native_mint::ACCOUNT_DATA.to_vec(),
                lamports: pay_to_lamports(1.),
                executable: false,
                rent_epoch: self.epoch() + 1,
            });

            // As a workaround for
            // https://github.com/paychains-labs/paychains-program-library/issues/374, ensure that the
            // spl-token 2 native mint account is owned by the spl-token 2 program.
            let store = if let Some(existing_native_mint_account) =
                self.get_account_with_fixed_root(&inline_spl_token::native_mint::id())
            {
                if existing_native_mint_account.owner() == &paychains_sdk::system_program::id() {
...
pub fn is_simple_vote_transaction(transaction: &SanitizedTransaction) -> bool {
    if transaction.message().instructions().len() == 1 {
        let (program_pubkey, instruction) = transaction
            ...
            .next()
            .unwrap();
        if program_pubkey == &paychains_vote_program::id() {
...
pub(crate) mod tests {
    ...
    #[allow(clippy::float_cmp)]
    fn test_bank_new() {
        let dummy_leader_pubkey = paychains_sdk::pubkey::new_rand();
    ...
    fn test_rent_distribution() {
        ...
        let bootstrap_validator_pubkey = paychains_sdk::pubkey::new_rand();
        ...
        let validator_1_pubkey = paychains_sdk::pubkey::new_rand();
        ...
        let validator_2_pubkey = paychains_sdk::pubkey::new_rand();
        ...
        let validator_3_pubkey = paychains_sdk::pubkey::new_rand();
    ...
    fn test_distribute_rent_to_validators_overflow() {
        ...
        let validator_pubkey = paychains_sdk::pubkey::new_rand();
    ...
    fn test_rent_exempt_executable_account() {
        ...
        let mut account =
            AccountSharedData::new(account_balance, data_len, &paychains_sdk::pubkey::new_rand());
    ...
    fn map_to_test_bad_range() -> std::collections::BTreeMap<Pubkey, i8> {
        ...
        map.insert(paychains_sdk::pubkey::new_rand(), 1);
        map
    }
    ...
    fn test_rent_eager_collect_rent_in_partition() {
        ...
        let zero_lamport_pubkey = paychains_sdk::pubkey::new_rand();
        let rent_due_pubkey = paychains_sdk::pubkey::new_rand();
        let rent_exempt_pubkey = paychains_sdk::pubkey::new_rand();
    ...
    fn do_test_bank_update_rewards_determinism() -> u64 {
        ...
        let vote_id = paychains_sdk::pubkey::new_rand();
        let mut vote_account =
            vote_state::create_account(&vote_id, &paychains_sdk::pubkey::new_rand(), 50, 100);
    ...
    fn test_transfer_to_sysvar() {
        ...
        let normal_pubkey = paychains_sdk::pubkey::new_rand();
    ...
    fn test_bank_tx_fee() {
        ...
        let leader = paychains_sdk::pubkey::new_rand();
        let GenesisConfigInfo {
            mut genesis_config,
            mint_keypair,
            ..
    ...
    fn test_readonly_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &paychains_sdk::pubkey::new_rand(), 0);
        let bank = Bank::new_for_tests(&genesis_config);

        let vote_pubkey0 = paychains_sdk::pubkey::new_rand();
        let vote_pubkey1 = paychains_sdk::pubkey::new_rand();
        let vote_pubkey2 = paychains_sdk::pubkey::new_rand();
    ...
    fn test_readonly_relaxed_locks() {
        ...
        let key3 = paychains_sdk::pubkey::new_rand();
    ...
    fn test_bank_hash_internal_state_verify() {
        ...
        let bank2 = Bank::new_from_parent(&bank0, &paychains_sdk::pubkey::new_rand(), 1);
        ...
        bank2.update_accounts_hash();
        assert!(bank2.verify_bank_hash(true));
        let bank3 = Bank::new_from_parent(&bank0, &paychains_sdk::pubkey::new_rand(), 2);
    ...
    fn test_bank_update_sysvar_account() {
        ...
        let dummy_clock_id = paychains_sdk::pubkey::new_rand();
    ...
    fn test_bank_inherit_tx_count() {
        ...
        // Bank 2
        let bank2 = Bank::new_from_parent(&bank0, &paychains_sdk::pubkey::new_rand(), 2);
        ...
        let bank6 = Bank::new_from_parent(&bank1, &paychains_sdk::pubkey::new_rand(), 3);
        assert_eq!(bank1.transaction_count(), 1);
    ...
    fn test_bank_vote_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &paychains_sdk::pubkey::new_rand(), 1);
        let bank = Arc::new(Bank::new_for_tests(&genesis_config));
    ...
    fn test_is_delta_with_no_committables() {
        ...
        assert_eq!(
            bank.transfer(10_001, &mint_keypair, &paychains_sdk::pubkey::new_rand()),
            Err(TransactionError::InstructionError(
                0,
                SystemError::ResultWithNegativeLamports.into(),
            ))
    ...
    fn test_bank_get_program_accounts() {
        ...
        assert!(
            genesis_accounts
                .iter()
                .any(|(pubkey, _, _)| paychains_sdk::sysvar::is_sysvar_id(pubkey)),
            "no sysvars found"
        );
    ...
    fn test_add_duplicate_static_program() {
        ...
        let vote_loader_account = bank.get_account(&paychains_vote_program::id()).unwrap();
        bank.add_builtin(
            "paychains_vote_program",
            &paychains_vote_program::id(),
            mock_vote_processor,
        );
        let new_vote_loader_account = bank.get_account(&paychains_vote_program::id()).unwrap();
    ...
    fn test_transaction_with_duplicate_accounts_in_instruction() {
        ...
        let from_pubkey = paychains_sdk::pubkey::new_rand();
    ...
    fn test_account_ids_after_program_ids() {
        ...
        let instruction =
            Instruction::new_with_bincode(paychains_vote_program::id(), &10, account_metas);
        let mut tx = Transaction::new_signed_with_payer(
            &[instruction],
            Some(&mint_keypair.pubkey()),
            &[&mint_keypair],
        ...
        tx.message.account_keys.push(paychains_sdk::pubkey::new_rand());
        ...
        let result = bank.process_transaction(&tx);
        assert_eq!(result, Ok(()));
        let account = bank.get_account(&paychains_vote_program::id()).unwrap();
    ...
    fn test_program_id_as_payer() {
        ...
        tx.message.account_keys.push(paychains_vote_program::id());
    ...
    fn test_same_program_id_uses_unqiue_executable_accounts() {
        ...
        // Add a new program
        let program1_pubkey = paychains_sdk::pubkey::new_rand();
        bank.add_builtin("program", &program1_pubkey, nested_processor);

        // Add a new program owned by the first
        let program2_pubkey = paychains_sdk::pubkey::new_rand();
    ...
    fn test_add_builtin_loader_no_overwrite() {
        ...
        let slot = 123;
        let loader_id = paychains_sdk::pubkey::new_rand();
    ...
    fn test_reconfigure_token2_native_mint() {
        ...
        let mut genesis_config =
            create_genesis_config_with_leader(5, &paychains_sdk::pubkey::new_rand(), 0).genesis_config;
    ...
    fn test_ensure_no_storage_rewards_pool() {
        ...
        let reward_pubkey = paychains_sdk::pubkey::new_rand();
        genesis_config.rewards_pools.insert(
            reward_pubkey,
            Account::new(u64::MAX, 0, &paychains_sdk::pubkey::new_rand()),
        );
        let bank0 = Bank::new_for_tests(&genesis_config);
    ...
    fn test_cached_executors() {
        ...
        let key2 = paychains_sdk::pubkey::new_rand();
        let key3 = paychains_sdk::pubkey::new_rand();
        let key4 = paychains_sdk::pubkey::new_rand();
    ...
    fn test_bank_executor_cache() {
        ...
        // Check inheritance
        let bank = Bank::new_from_parent(&Arc::new(bank), &paychains_sdk::pubkey::new_rand(), 1);
        let executors = bank.get_executors(&message, accounts, program_indices);
        assert_eq!(executors.borrow().len(), 4);
        assert!(executors.borrow().contains_key(&key1));
        assert!(executors.borrow().contains_key(&key2));
    ...
    fn test_rent_for_sysvars_adjustment_full_set() {
        ...
        fn mock_process_instruction(
            ...
            _data: &[u8],
            _invoke_context: &mut InvokeContext,
        ) -> std::result::Result<(), paychains_sdk::instruction::InstructionError> {
            Ok(())
        }
            ...
            ) + std::marker::Send,
    {
        ...
        let all_pubkeys: Vec<Pubkey> = std::iter::repeat_with(paychains_sdk::pubkey::new_rand)
            .take(total_pubkeys)
            .collect();
    ...
    fn test_get_inflation_start_slot_devnet_testnet() {
        let GenesisConfigInfo {
            mut genesis_config, ..
        } = create_genesis_config_with_leader(42, &paychains_sdk::pubkey::new_rand(), 42);
        genesis_config
            .accounts
    ...
    fn test_get_largest_accounts() {
        ...
        // Initialize accounts; all have larger PAY balances than current Bank built-ins
        ...
        assert_eq!(
            bank.get_largest_accounts(1, &pubkeys_hashset, AccountAddressFilter::Include)
                .unwrap(),
            vec![(pubkeys[4], pay_to_lamports(5.0))]
        );
        assert_eq!(
        ...
        assert_eq!(
            bank.get_largest_accounts(1, &exclude4, AccountAddressFilter::Exclude)
                .unwrap(),
            vec![(pubkeys[3], pay_to_lamports(4.0))]
        );
    ...
    fn test_call_precomiled_program() {
        ...
        let instruction = paychains_sdk::secp256k1_instruction::new_secp256k1_instruction(
            &secp_privkey,
            message_arr,
        );
        let tx = Transaction::new_signed_with_payer(
        ...
        let message_arr = b"hello";
        let instruction =
            paychains_sdk::ed25519_instruction::new_ed25519_instruction(&privkey, message_arr);
        let tx = Transaction::new_signed_with_payer(
            &[instruction],
            Some(&mint_keypair.pubkey()),
            &[&mint_keypair],
    ...
    fn test_an_empty_instruction_without_program() {
        let (genesis_config, mint_keypair) = create_genesis_config(1);
        let destination = paychains_sdk::pubkey::new_rand();
    ...
    fn test_accounts_data_budget_exceeded() {
        use paychains_program_runtime::accounts_data_meter::MAX_ACCOUNTS_DATA_LEN;
        use paychains_sdk::system_instruction::MAX_PERMITTED_DATA_LENGTH;

        paychains_logger::setup();
        let (genesis_config, mint_keypair) = create_genesis_config(1_000_000_000_000);
        let mut bank = Bank::new_for_tests(&genesis_config);
        bank.activate_feature(&paychains_sdk::feature_set::cap_accounts_data_len::id());
        ...
        let result = loop {
            let txn = system_transaction::create_account(
                ...
                &paychains_sdk::system_program::id(),
            );
        ...
        assert!(matches!(
            ...
            Err(TransactionError::InstructionError(
                _,
                paychains_sdk::instruction::InstructionError::AccountsDataBudgetExceeded,
            ))
        ));
    }
    ...
    fn test_invalid_rent_state_changes_existing_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(pay_to_lamports(100.), &Pubkey::new_unique(), 42);
    ...
    fn test_rent_state_changes_sysvars() {
        ...
        let validator_pubkey = paychains_sdk::pubkey::new_rand();
        let validator_stake_lamports = pay_to_lamports(1.);
