use {
    ...
    paychains_cli_output::{display::println_name_value, OutputFormat},
    paychains_client::rpc_config::RpcSendTransactionConfig,
...
fn main() -> Result<(), Box<dyn error::Error>> {
    paychains_logger::setup_with_default("off");
