use {
    ...
    paychains_clap_utils::{self, input_validators::*, keypair::*},
    ...
    App::new(name)
        ...
        .arg(
            Arg::with_name("websocket_url")
                ...
                .global(true)
                .validator(is_url)
                .help("WebSocket URL for the paychains cluster"),
        )
        .arg(
        ...
        .subcommand(
            SubCommand::with_name("config")
                .about("PayChains command-line tool configuration settings")
                .aliases(&["get", "set"])
                .setting(AppSettings::SubcommandRequiredElseHelp)
                .subcommand(
