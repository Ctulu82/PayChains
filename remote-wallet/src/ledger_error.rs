...
pub enum LedgerError {
    #[error("PayChains app not open on Ledger device")]
    ...
    #[error("Ledger received invalid PayChains message")]
    PayChainsInvalidMessage = 0x6a80,

    #[error("PayChains summary finalization failed on Ledger device")]
    PayChainsSummaryFinalizeFailed = 0x6f00,

    #[error("PayChains summary update failed on Ledger device")]
    PayChainsSummaryUpdateFailed = 0x6f01,
