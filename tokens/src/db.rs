use {
    ...
    paychains_sdk::{clock::Slot, pubkey::Pubkey, signature::Signature, transaction::Transaction},
...
mod tests {
    use {
        ...
        paychains_sdk::transaction::TransactionError,
    ...
    fn test_sort_transaction_infos_finalized_first() {
        ...
        let info3 = TransactionInfo {
            recipient: paychains_sdk::pubkey::new_rand(),
            ..TransactionInfo::default()
        };
