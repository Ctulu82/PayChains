use {
    ...
    paychains_cli_config::CONFIG_FILE,
    paychains_remote_wallet::remote_wallet::maybe_wallet_manager,
    paychains_sdk::native_token::pay_to_lamports,
    ...
    App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("url")
                ...
                .takes_value(true)
                .value_name("URL")
                .help("RPC entrypoint address. i.e. http://api.devnet.paychains.com"),
        )
        .subcommand(
            SubCommand::with_name("distribute-tokens")
                .about("Distribute PAY")
                .arg(
                ...
                .arg(
                    Arg::with_name("transfer_amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("The amount to send to each recipient, in PAY"),
                )
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("create-stake")
                ...
                .arg(
                    Arg::with_name("unlocked_pay")
                        .default_value("1.0")
                        .long("unlocked-pay")
                        .takes_value(true)
                        .value_name("PAY_AMOUNT")
                        .help("Amount of PAY to put in system account to pay for fees"),
                )
                .arg(
...
fn parse_distribute_tokens_args(
    ...
    Ok(DistributeTokensArgs {
        ...
        stake_args: None,
        spl_token_args: None,
        transfer_amount: value_of(matches, "transfer_amount").map(pay_to_lamports),
    })
}
...
fn parse_create_stake_args(
    ...
    let stake_args = StakeArgs {
        unlocked_pay: pay_to_lamports(value_t_or_exit!(matches, "unlocked_pay", f64)),
        lockup_authority,
