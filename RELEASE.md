...
1. Create the new branch and push this branch to the `paychains` repository:
    ```
...
1. Go to [GitHub Releases](https://github.com/paychains-labs/paychains/releases) for tagging a release.
...
1. Fill the release notes.
   ...
   template](https://raw.githubusercontent.com/paychains-labs/paychains/master/.github/RELEASE_TEMPLATE.md).  Engineering Lead can provide summary contents for release notes if needed.
...
1.  Go to [GitHub Releases](https://github.com/paychains-labs/paychains/releases) and create a new draft release for `X.Y.Z+1` with empty release notes.  This allows people to incrementally add new release notes until it's time for the next release
    1. Also, point the branch field to the same branch and mark the relese as **"This is a pre-release"**.
1.  Go to the [Github Milestones](https://github.com/paychains-labs/paychains/milestones).  Create a new milestone for the `X.Y.Z+1`, move over
unresolved issues still in the `X.Y.Z` milestone, then close the `X.Y.Z` milestone.

### Verify release automation success
Go to [PayChains Releases](https://github.com/paychains-labs/paychains/releases) and click on the latest release that you just published.
...
* The `paychains-secondary` Buildkite pipeline handles creating the Linux release artifacts and updated crates.  Look for a job under the tag name of the release: https://buildkite.com/paychains-labs/paychains-secondary.
* The macOS and Windows release artifacts are produced by Travis CI: https://travis-ci.com/github/paychains-labs/paychains/branches

[Crates.io](https://crates.io/crates/paychains) should have an updated PayChains version.  This can take 2-3 hours, and sometimes fails in the `paychains-secondary` job.
If this happens and the error is non-fatal, click "Retry" on the "publish crate" job

### Update software on testnet.paychains.com
See the documentation at https://github.com/paychains-labs/cluster-ops/. devnet.paychains.com and mainnet-beta.paychains.com run stable releases that have been tested on testnet. Do not update devnet or mainnet-beta with a beta release.
