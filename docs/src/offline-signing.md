...
- Collecting signatures from geographically disparate signers in a
  [multi-signature scheme](https://spl.paychains.com/token#multisig-usage)
- Signing transactions using an [airgapped](<https://en.wikipedia.org/wiki/Air_gap_(networking)>)
  signing device

This document describes using PayChains's CLI to separately sign and submit a
transaction.
...
- [`create-stake-account`](cli/usage.md#paychains-create-stake-account)
- [`create-stake-account-checked`](cli/usage.md#paychains-create-stake-account-checked)
- [`deactivate-stake`](cli/usage.md#paychains-deactivate-stake)
- [`delegate-stake`](cli/usage.md#paychains-delegate-stake)
- [`split-stake`](cli/usage.md#paychains-split-stake)
- [`stake-authorize`](cli/usage.md#paychains-stake-authorize)
- [`stake-authorize-checked`](cli/usage.md#paychains-stake-authorize-checked)
- [`stake-set-lockup`](cli/usage.md#paychains-stake-set-lockup)
- [`stake-set-lockup-checked`](cli/usage.md#paychains-stake-set-lockup-checked)
- [`transfer`](cli/usage.md#paychains-transfer)
- [`withdraw-stake`](cli/usage.md#paychains-withdraw-stake)

- [`create-vote-account`](cli/usage.md#paychains-create-vote-account)
- [`vote-authorize-voter`](cli/usage.md#paychains-vote-authorize-voter)
- [`vote-authorize-voter-checked`](cli/usage.md#paychains-vote-authorize-voter-checked)
- [`vote-authorize-withdrawer`](cli/usage.md#paychains-vote-authorize-withdrawer)
...
- [`withdraw-from-vote-account`](cli/usage.md#paychains-withdraw-from-vote-account)
...
```bash
paychains@offline$ paychains pay --sign-only --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```bash
paychains@online$ paychains pay --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```text
paychains@offline1$ paychains transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
...
```text
paychains@offline2$ paychains transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --sign-only \
    --keypair from.json \
...
```text
paychains@online$ paychains transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --from 674RgFMgdqdRoVtMqSBg7mHFbrrNm1h1r721H1ZMquHL \
...
Typically a PayChains transaction must be signed and accepted by the network within
