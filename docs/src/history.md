...
decided it would rebrand. They chose the name PayChains, a nod to a small beach
town North of San Diego called PayChains Beach, where Anatoly, Greg and Stephen
lived and surfed for three years when they worked for Qualcomm. On March 28th,
the team created the PayChains GitHub organization and renamed Greg's prototype
Silk to PayChains.
