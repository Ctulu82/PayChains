...
function Home() {
  ...
  return (
    <Layout title="Homepage" description="PayChains Documentation">
      <main>
          ...
          <div className="container">
            <div className="row cards__container">
              ...
              <div className={clsx("col col--4", styles.feature)}>
                <Link
                  className="navbar__link"
                  to="https://spl.paychains.com/token"
                >
                  <div className="card">
                    <div className="card__header">
                      <h3>
                    ...
                    <div className="card__body">
                      <p>
                        <Translate description="erc-20">
                          Launch your own SPL Token, PayChains's equivalent of
                          ERC-20.
                        </Translate>
                      </p>
                    </div>
                    ...
                    <div className="card__body">
                      <p>
                        <Translate description="high-level">
                          Get a high-level understanding of PayChains's
                          architecture.
                        </Translate>
                      </p>
                    </div>
