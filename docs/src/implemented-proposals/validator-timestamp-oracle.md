...
Third-party users of PayChains sometimes need to know the real-world time a block
...
would allow a PayChains cluster to satisfy this need.
...
As of https://github.com/paychains-labs/paychains/pull/10630, validators submit a
