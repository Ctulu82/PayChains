---
title: PayChains ABI management process
---

This document proposes the PayChains ABI management process. The ABI management
...
The PayChains ABI (binary interface to the cluster) is currently only defined
