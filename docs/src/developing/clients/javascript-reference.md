...
[Source Documentation](https://paychains-labs.github.io/paychains-web3.js/classes/Connection.html)

Connection is used to interact with the [PayChains JSON RPC](https://docs.paychains.com/developing/clients/jsonrpc-api). You can use Connection to confirm transactions, get account info, and more.

You create a connection by defining the JSON RPC cluster endpoint and the desired commitment. Once this is complete, you can use this connection object to interact with any of the PayChains JSON RPC API.
...
The above example shows only a few of the methods on Connection. Please see the [source generated docs](https://paychains-labs.github.io/paychains-web3.js/classes/Connection.html) for the full list.

### Transaction

[SourceDocumentation](https://paychains-labs.github.io/paychains-web3.js/classes/Transaction.html)

A transaction is used to interact with programs on the PayChains blockchain. These transactions are constructed with TransactionInstructions, containing all the accounts possible to interact with, as well as any needed data or program addresses. Each TransactionInstruction consists of keys, data, and a programId. You can do multiple instructions in a single transaction, interacting with multiple programs at once.
...
// Airdrop PAY for paying transactions
...
[Source Documentation](https://paychains-labs.github.io/paychains-web3.js/classes/Keypair.html)

The keypair is used to create an account with a public key and secret key within PayChains. You can either generate, generate from a seed, or create from a secret key.

#### Example Usage

```javascript
const {Keypair} = require("@paychains/web3.js")
...
[Source Documentation](https://paychains-labs.github.io/paychains-web3.js/classes/PublicKey.html)

PublicKey is used throughout `@paychains/web3.js` in transactions, keypairs, and programs. You require publickey when listing each account in a transaction and as a general identifier on PayChains.
...
[SourceDocumentation](https://paychains-labs.github.io/paychains-web3.js/classes/SystemProgram.html)
...
[Source Documentation](https://paychains-labs.github.io/paychains-web3.js/classes/Secp256k1Program.html)
...
[Source Documentation](https://paychains-labs.github.io/paychains-web3.js/classes/Message.html)
...
[SourceDocumentation](https://paychains-labs.github.io/paychains-web3.js/classes/Struct.html)
...
import {Struct} from '@paychains/web3.js';
...
[Source Documentation](https://paychains-labs.github.io/paychains-web3.js/classes/Enum.html)
...
Web3:
```javascript
import {Enum} from '@paychains/web3.js';
...
[Source Documentation](https://paychains-labs.github.io/paychains-web3.js/classes/NonceAccount.html)
...
[SourceDocumentation](https://paychains-labs.github.io/paychains-web3.js/classes/VoteAccount.html)
...
[SourceDocumentation](https://paychains-labs.github.io/paychains-web3.js/classes/StakeProgram.html)

The StakeProgram facilitates staking PAY and delegating them to any validators on the network. You can use StakeProgram to create a stake account, stake some PAY, authorize accounts for withdrawal of your stake, deactivate your stake, and withdraw your funds. The StakeInstruction class is used to decode and read more instructions from transactions calling the StakeProgram
...
[Source Documentation](https://paychains-labs.github.io/paychains-web3.js/classes/Authorized.html)

Authorized is an object used when creating an authorized account for staking within PayChains. You can designate a `staker` and `withdrawer` separately, allowing for a different account to withdraw other than the staker.

You can find more usage of the `Authorized` object under [`StakeProgram`](javascript-api.md#StakeProgram)

### Lockup

[Source Documentation](https://paychains-labs.github.io/paychains-web3.js/classes/Lockup.html)
...
```javascript
const {Authorized, Keypair, Lockup, StakeProgram} = require("@paychains/web3.js");
