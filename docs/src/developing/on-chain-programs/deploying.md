...
to an ELF shared object containing BPF bytecode, and uploads it to the PayChains
...
The PayChains command line interface supports deploying programs, for more
