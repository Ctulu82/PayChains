...
The sample [postgresql.conf](https://github.com/paychains-labs/paychains/blob/7ac43b16d2c766df61ae0a06d7aaf14ba61996ac/accountsdb-plugin-postgres/scripts/postgresql.conf)
