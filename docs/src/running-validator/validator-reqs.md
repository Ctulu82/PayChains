...
There is no strict minimum amount of PAY required to run a validator on PayChains.

However in order to participate in consensus, a vote account is required which
has a rent-exempt reserve of 0.02685864 PAY. Voting also requires sending a vote
...
releases at [paychainslabs/paychains](https://hub.docker.com/r/paychainslabs/paychains).

## Software

- We build and run on Ubuntu 20.04.
- See [Installing PayChains](../cli/install-paychains-cli-tools.md) for the current PayChains software release.
...
CUDA is required to make use of the GPU on your system. The provided PayChains
