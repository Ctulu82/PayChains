---
title: Using PayChains CLI
---

Before running any PayChains CLI commands, let's go over some conventions that
you will see across all commands. First, the PayChains CLI is actually a collection
...
```bash
paychains-keygen pubkey <KEYPAIR>
```
...
`/home/paychains/my_wallet.json`, to display the address, do:

```bash
paychains-keygen pubkey /home/paychains/my_wallet.json
```
