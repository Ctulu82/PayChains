---
title: Using Hardware Wallets on the PayChains CLI
---
...
The PayChains CLI has first class support for hardware wallets. Anywhere
...
The PayChains CLI supports the following hardware wallets:

- [Ledger Nano S and Ledger Nano X](hardware-wallets/ledger.md)

## Specify a Keypair URL

PayChains defines a keypair URL format to uniquely locate any PayChains keypair on a
...
`DERVIATION_PATH` is used to navigate to PayChains keys within your hardware wallet.
...
and that any derived keys are PayChains keys (Coin type 501). The single quote
indicates a "hardened" derivation. Because PayChains uses Ed25519 keypairs, all
