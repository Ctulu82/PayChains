#pragma once
/**
 * @brief PayChains return data system calls
**/
 ...
 */
void pay_set_return_data(const uint8_t *bytes, uint64_t bytes_len);
 ...
 */
uint64_t pay_get_return_data(const uint8_t *bytes, uint64_t bytes_len, PayPubkey *program_id);
