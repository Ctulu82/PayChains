//! PayChains Rust-based BPF program entry point supported by the latest
...
/// errors. To avoid this, it is common for PayChains programs to define an
...
/// [BPF]: https://docs.paychains.com/developing/on-chain-programs/overview#berkeley-packet-filter-bpf
///
/// # Cargo features
///
...
///
/// # Defining a panic handler for PayChains
///
/// _The mechanism for defining a PayChains panic handler is different [from most
...
/// ```
///
/// The above is how PayChains defines the default panic handler.
#[macro_export]
