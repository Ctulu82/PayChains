//! Types for directing the execution of PayChains programs.
//!
//! Every invocation of a PayChains program executes a single instruction, as
...
//! the PayChains runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the PayChains runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across PayChains software versions.
    ///
...
/// A directive for a single invocation of a PayChains program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by PayChains
/// clients. Instructions are also used to describe [cross-program
/// invocations][cpi].
///
/// [cpi]: https://docs.paychains.com/developing/programming-model/calling-between-programs
///
/// During execution, a program will receive a list of account data as one of
/// its arguments, in the same order as specified during `Instruction`
/// construction.
///
/// While PayChains is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the PayChains runtime coalesces all accounts used
...
///
/// Note that because the PayChains runtime schedules parallel transaction
...
/// which is the core of a PayChains transaction. It is created during the
