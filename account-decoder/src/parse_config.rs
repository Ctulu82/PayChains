use {
    ...
    bincode::deserialize,
    serde_json::Value,
    paychains_config_program::{get_config_data, ConfigKeys},
    paychains_sdk::{
        pubkey::Pubkey,
...
mod test {
    use {
        ...
        paychains_config_program::create_config_account, paychains_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = paychains_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"PayChains"}"#).unwrap(),
            }),
        );
