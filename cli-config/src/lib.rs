//! Loading and saving the PayChains CLI configuration file.
//!
//! The configuration file used by the PayChains CLI includes information about the
//! RPC node to connect to, the path to the user's signing source, and more.
//! Other software than the PayChains CLI may wish to access the same configuration
//! and signer.
//!
...
//!   the documentation for `paychains_clap_utils::keypair::signer_from_path`.
//!
...
//! ```no_run
//! use anyhow::anyhow;
//! use paychains_cli_config::{CONFIG_FILE, Config};
//!
//! let config_file = paychains_cli_config::CONFIG_FILE.as_ref()
//!     .ok_or_else(|| anyhow!("unable to get config file path"))?;
//! let mut cli_config = Config::load(&config_file)?;
//! // Set the RPC URL to devnet
//! cli_config.json_rpc_url = "https://api.devnet.paychains.com".to_string();
