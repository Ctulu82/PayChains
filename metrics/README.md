...
release channels:
* https://metrics.paychains.com:3000/d/monitor-edge/cluster-telemetry-edge
* https://metrics.paychains.com:3000/d/monitor-beta/cluster-telemetry-beta
* https://metrics.paychains.com:3000/d/monitor/cluster-telemetry
...
https://buildkite.com/paychains-labs/publish-metrics-dashboard.
...
* Check out metrics to add at https://metrics.paychains.com:8888/ in the data explorer.
...
```
$ export GRAFANA_API_TOKEN="an API key from https://metrics.paychains.com:3000/org/apikeys"
