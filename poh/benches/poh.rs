// This bench attempts to justify the value of `paychains_core::poh_service::NUM_HASHES_PER_BATCH`

#![feature(test)]
extern crate test;

use {
    paychains_entry::poh::Poh,
    paychains_poh::poh_service::DEFAULT_HASHES_PER_BATCH,
