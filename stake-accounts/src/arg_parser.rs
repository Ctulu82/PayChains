...
fn fee_payer_arg<'a, 'b>() -> Arg<'a, 'b> {
    paychains_clap_utils::fee_payer::fee_payer_arg().required(true)
}
    ...
    T: Into<OsString> + Clone,
{
    ...
    App::new("paychains-stake-accounts")
        .about("about")
        .version("version")
        .arg(
            ...
            SubCommand::with_name("new")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("Amount to move into the new stake accounts, in PAY"),
                )
                .arg(
                    Arg::with_name("stake_authority")
                        .long("stake-authority")
...
fn parse_new_args(matches: &ArgMatches<'_>) -> NewArgs<String, String> {
    NewArgs {
        ...
        lamports: pay_to_lamports(value_t_or_exit!(matches, "amount", f64)),
