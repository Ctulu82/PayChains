...
mod tests {
    ...
    fn test_new_derived_stake_account() {
        ...
        let lamports = rent + 1;
        let stake_authority_pubkey = paychains_sdk::pubkey::new_rand();
        let withdraw_authority_pubkey = paychains_sdk::pubkey::new_rand();
    ...
    fn test_authorize_stake_accounts() {
        ...
        let new_stake_authority_pubkey = paychains_sdk::pubkey::new_rand();
        let new_withdraw_authority_pubkey = paychains_sdk::pubkey::new_rand();
