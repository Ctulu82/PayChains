...
of the [PayChains Labs](https://hub.docker.com/u/paychainslabs/) Docker Hub
organization.
...
1. Run `PAYCHAINS_ALLOCATE_TTY=1 PAYCHAINS_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull paychainslabs/rust-nightly:YYYY-MM-DD ci/test-checks.sh`
   and `PAYCHAINS_ALLOCATE_TTY=1 PAYCHAINS_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull paychainslabs/rust-nightly:YYYY-MM-DD ci/test-coverage.sh [args]...`
