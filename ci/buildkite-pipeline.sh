...
if [[ -n $BUILDKITE_TAG ]]; then
  ...
  annotate --style info --context release-tag \
    "https://github.com/paychains-labs/paychains/releases/$BUILDKITE_TAG"
...
if [[ $BUILDKITE_BRANCH =~ ^pull ]]; then
  ...
  annotate --style info --context pr-backlink \
    "Github Pull Request: https://github.com/paychains-labs/paychains/$BUILDKITE_BRANCH"
