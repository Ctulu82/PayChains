...
export function SupplyCard() {
  ...
  return (
    <div className="card">
      ...
      <TableCardBody>
        <tr>
          <td className="w-100">Total Supply (PAY)</td>
          <td className="text-lg-end">
            <PayBalance lamports={supply.total} maximumFractionDigits={0} />
          </td>
        </tr>

        <tr>
          <td className="w-100">Circulating Supply (PAY)</td>
          <td className="text-lg-end">
            <PayBalance
        ...
        <tr>
          <td className="w-100">Non-Circulating Supply (PAY)</td>
          <td className="text-lg-end">
            <PayBalance
