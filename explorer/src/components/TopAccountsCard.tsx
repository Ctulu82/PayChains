...
import { AccountBalancePair } from "@paychains/web3.js";
            ...
            <table className="table table-sm table-nowrap card-table">
              <thead>
                <tr>
                  ...
                  <th className="text-muted text-end">Balance (PAY)</th>
  ...
  return (
    <tr key={index}>
      ...
      <td className="text-end">
        <PayBalance lamports={account.lamports} maximumFractionDigits={0} />
      </td>
