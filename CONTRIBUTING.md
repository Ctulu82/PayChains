...
then about 1,000 lines of changes is about the most you should ask a PayChains
...
is ready to be integrated, the PayChains maintainers will work with you to decide
...
mechanism. Draft PRs are a convenient way to collaborate with the PayChains
...
PayChains's architecture is described by docs generated from markdown files in
...
[Accepted Design Proposals](https://docs.paychains.com/proposals/accepted-design-proposals)
section of the PayChains docs.  Here's the full process:
