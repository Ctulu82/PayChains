...
identity=$PAYCHAINS_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$PAYCHAINS_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$PAYCHAINS_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {
