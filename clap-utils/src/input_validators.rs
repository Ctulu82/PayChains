...
pub fn normalize_to_url_if_moniker<T: AsRef<str>>(url_or_moniker: T) -> String {
    match url_or_moniker.as_ref() {
        "m" | "mainnet-beta" => "https://api.mainnet-beta.paychains.com",
        "t" | "testnet" => "https://api.testnet.paychains.com",
        "d" | "devnet" => "https://api.devnet.paychains.com",
    ...
    T: AsRef<str> + Display,
{
    ...
    if paychains_perf::thread::is_renice_allowed(adjustment) {
        Ok(())
    } else {
        Err(String::from(
